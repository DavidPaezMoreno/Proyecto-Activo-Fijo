<%@ Page Language="C#" AutoEventWireup="True" Inherits="Ingresar" Codebehind="Ingresar.aspx.cs" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <link href="Login.css" rel="stylesheet" type="text/css" />
    <title>Activo Fijo::Ingresar</title>
</head>
<body>
    ...
    <div class="FormaLogin">
        ...
        <div class="CenterFormaLogin">
            <div class="cPosRel" style="width: 370px; height: 90px; margin: 34px auto 0px auto; text-align:justify;">
                ...
                <br />
                <span>
                    <%= Request.ServerVariables["REMOTE_ADDR"]%></span>
                <asp:TextBox ID="txtPrueba" runat="server" Width="181px"></asp:TextBox>
                <br />
                <span>
            ...
            <div class="cFL cPosRel" style="width: 450px; height: 150px;">
                ...
                <div class="cFL cPosRel" style="width: 290px; height: 25px;" id="txtUsers">
                    <asp:TextBox ID="txtUser" CssClass="txtControl" runat="server" 
                         Width="262px"></asp:TextBox>
                </div>
                <div class="cFL cPosRel" style="width: 100px; height: 25px; margin-top: 15px;">
                    <span class="cFR cPosRel TextoLogin" style="margin-top: 7px;">Contraseña:</span>
                </div>
                <div class="cFL cPosRel" style="width: 290px; height: 25px; margin-top: 15px;">
                    <asp:TextBox ID="txtContrasena" TextMode="Password" CssClass="txtControl" 
                ...
                <div class="cFL cPosRel" style="width: 460px;">
                    <div style="width: 120px; height: 30px; margin-left: auto; margin-right: auto; margin-top: 15px;">
                        <asp:ImageButton ID="btnIniciar" ImageUrl="~/include/imagenes/login/ingresarsistema.jpg" runat="server" OnClick="btnIniciar_Click" />
                    </div>
                </div>
            </div>
